...
public class PasskeyLoginWidget extends Widget implements WithPasskeyAssertionOptions {

    @Getter
    private final JSON assertionOptions;

    public PasskeyLoginWidget(Context context, WidgetModel.PasskeyLoginWidgetModel widgetModel) {
        super(context);
        this.assertionOptions = widgetModel.getAssertionOptions();
